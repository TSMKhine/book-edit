...
import trianglularBiImg from '@/assets/compass/ruler_triangular-bisector.png';
...
const RULER_WIDTH = 412;

export default function TriangularBi(props: TRulerProps) {
  ...
  return (
    <div
      ...
      onPointerDown={() => {
        bringToFront();
        handlePointerDownInside(RULER_KIND.TRIANGULAR_BI);
      }}
      ref={wrapperRef}
    >
      <div
      ...
      >
        ...
        >
          <Image src={trianglularBiImg} alt="" />
        </div>
        ...
        {/* height-area */}
        <div
          className="absolute -left-[10px] top-0 h-full w-[20px]"
          onPointerDown={(e) => handleOnDown(e, 'height')}
        ></div>

        {/* slide-area */}
        <div
          className="absolute origin-top-left rotate-45"
          style={{
            top: '14px',
            left: '26px',
            height: '20px',
      ...
      <Moveable
        ...
        ables={[CustomButtons]}
        props={{ customButtons: focusedRuler === RULER_KIND.TRIANGULAR_BI }}
